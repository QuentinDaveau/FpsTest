...
func _init() -> void:
	...
	register_inventory(CharacterInventoryInterface.new(Inventory.new([TypeSlot.new(ItemDB.TYPE.PISTOL_AMMO, 60), Slot.new(30), TypeSlot.new(ItemDB.TYPE.PISTOL, 1)])))
